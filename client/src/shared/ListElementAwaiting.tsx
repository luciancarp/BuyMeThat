...
class ListElAwaiting extends React.Component<any,any>{
...
updateItemNote(e:any) {
  ...
  render() {
    ...
    >
      <MenuItem primaryText={'Accept'} onClick={() => {this.props.accept(this.props.elProps.id)}}/>
      <MenuItem primaryText={'Decline'} onClick={() => {this.props.onUpdateStatus(this.props.elProps.id, 6)}}/>
      <MenuItem primaryText={'Flag for Admin approval'} onClick={() => {this.props.onFlag(this.props.elProps.id)}}/>
    </IconMenu>
  );
