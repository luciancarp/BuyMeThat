...
class ListElManaged extends React.Component<any,any>{
...
updateItemNote(e:any) {
  ...
  render() {
    ...
    >
      <MenuItem primaryText={'Ordered'} onClick={() => {this.props.onUpdateStatus(this.props.elProps.id, 2)}}/>
      <MenuItem primaryText={'Delivered'} onClick={() => {this.props.onUpdateStatus(this.props.elProps.id, 3)}}/>
      <MenuItem primaryText={'Close order'} onClick={() => {this.props.onUpdateStatus(this.props.elProps.id, 4)}}/>
    </IconMenu>
  );
