...
class ProviderDrawerMenu extends React.Component<any, any> {
  ...
  handleClose = () => this.setState({open: false});
    ...
    openDashboard = () => location.href = '/ProviderDashboard';

  openNewRequest = () => location.href = '/providernewrequest';
...
export default ProviderDrawerMenu;